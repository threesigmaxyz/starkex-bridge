...
library ECDSA {
    ...
    uint256 constant BETA =
        3_141_592_653_589_793_238_462_643_383_279_502_884_197_169_399_375_105_820_974_944_592_307_816_406_665;
    uint256 constant EC_ORDER =
        3_618_502_788_666_131_213_697_322_783_095_070_105_526_743_751_716_087_489_154_079_457_884_512_865_583;
    ...
    function verify(uint256 msgHash, uint256 r, uint256 s, uint256 pubX, uint256 pubY) internal pure {
        ...
        // Verify that pub is a valid point (y^2 = x^3 + x + BETA).
        {
            ...
            if (y2 != addmod(addmod(x3, pubX, FIELD_PRIME), BETA, FIELD_PRIME)) {
