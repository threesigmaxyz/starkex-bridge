...
contract CelerReceptor is ICelerReceptor, CelerBase {
    ...
    /// @inheritdoc ICelerReceptor
    function executeMessage(address emitterAddress_, uint64 emitterChainId_, bytes calldata message_, address ) public payable override returns (ExecutionStatus) {
