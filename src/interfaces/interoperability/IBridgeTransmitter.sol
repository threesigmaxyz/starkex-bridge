...
interface IBridgeTransmitter {
     ...
     */
    function getFee(uint16 dstChainId_, bytes memory payload_) external view returns (uint256 nativeFee_);
     ...
     * @param payload_ The payload of the message.
     */
    function keep(uint16 dstChainId_, address payable refundAddress_, bytes memory payload_) external payable;
