...
interface ICelerTransmitter {
    ...
    /**
     * @notice Gets a quote for the send fee of Celer.
     * @param to_ The destination address.
     * @param data_ Data to be sent on message.
     * @return The estimated fee for sending a message.
     */
    function getCelerFee(address to_, bytes calldata data_) external returns (uint256);
